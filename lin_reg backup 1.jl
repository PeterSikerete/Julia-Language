...
# ╔═╡ c6b688f2-9fb5-11ec-2252-cdc194daafb4
md"# Implementing a linear regression from scratch in Julia"

# ╔═╡ 6ab1ff80-63bb-4f18-ab67-f96318689a2a
md"""First, we load the packages needed for training the model"""
...
# ╔═╡ 447c5492-67c8-4dd6-86a2-721ecdf1639d
...
# ╔═╡ 211f0f40-e833-4f1c-abe4-146fdb5b17a8
md""" The describe function provides some statistical information that helps
  understand each column in the dataset. However, it might not be enough to decide
  which column to select as a feature. Several techniques can be used to assist in
  feature selection. For example, here we use the Pearson correlation between
  variables in the dataset. This confirms our initial intuition that columns 3 to 7
  could serve as features based on their correlation with the last column. """
...
# ╔═╡ 7240e885-334b-4bf6-a02b-2b639332eac7
...
# ╔═╡ 97b37e9e-b4ee-494a-8e64-fc61c9e5a0c4
...
# ╔═╡ 5d5e4f15-ca60-4e61-a687-3c3926eadc55
...
# ╔═╡ 7438cb7f-306a-4fad-9988-a54f6a6ddef8
scaling_params = get_scaling_params(X_mat_train)

# ╔═╡ 8085a98c-75c1-42c6-9cca-8c4380d87eb7
scaling_params[1]

# ╔═╡ 1873c5bc-0080-4b24-b9bc-e33519487069
last(scaling_params)

# ╔═╡ 3964eea4-7a14-4cb0-a7dc-a048b9e17e28
scaled_training_features = scale_features(X_mat_train, scaling_params)

# ╔═╡ 8e72d472-c41b-446c-bc4c-127a3290e40b
scaled_testing_features = scale_features(X_mat_test, scaling_params)

# ╔═╡ f71c9ed1-e731-40d2-a118-38296b6b0207
...
# ╔═╡ b86ed19b-ac6d-46f7-a4eb-0072058ad68f
weights_tr_errors = train_model(scaled_training_features, Y_mat_train, 0.03,10000)

# ╔═╡ 0b8371bf-8cad-40ed-a8b3-5c0d8a126bdf
...
# ╔═╡ be1c6635-02ea-4b76-81f5-35f042321069
...
# ╔═╡ 429f6143-a3d6-4746-8a64-762d248f9513
