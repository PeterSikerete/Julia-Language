...
hdf = CSV.read("heart-disease.csv", DataFrame)
...
function get_scaling_params(init_feature_mat::Matrix{Float64})::Tuple{Matrix{Float64}, Matrix{Float64}}
...
function scale_features(feature_mat::Matrix{Float64}, sc_params::Tuple{Matrix{Float64}, Matrix{Float64}})::Matrix{Float64}
